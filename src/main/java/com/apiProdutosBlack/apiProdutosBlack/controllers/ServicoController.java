...
import com.apiProdutosBlack.apiProdutosBlack.dtos.ServicoDTO;
...
public class ServicoController {
	...
	@GetMapping
	@PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<Page<Servico>> getAllServicos(@PageableDefault(page = 0, sort = "idservico", 
    ...
    public ResponseEntity<Object> getServico(@PathVariable(value = "idservico") Integer idservico
	 ...
	 @PreAuthorize("hasRole('ROLE_ADMIN')")
	    public ResponseEntity<Object> updateServico(@PathVariable(value = "idservico") Integer idservico,
	                                                    @RequestBody @Valid ServicoDTO servicos
	                                                    ,@AuthenticationPrincipal UserDetails userDetails){
